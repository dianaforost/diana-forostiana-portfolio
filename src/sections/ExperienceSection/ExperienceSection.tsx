                ...
                >
                  <div className="text-left">
                    <a
                      ...
                      className="dark-cursor text-[24px] sm:text-[32] md:text-[36px] border-b-[3px] border-black hover:text-darkGray focus:text-darkGray hover:border-darkGray focus:border-darkGray transition duration-300"
                    >
                    ...
                    <a
                      ...
                      className="dark-cursor text-[16px] sm:text-[18px] md:text-[20] border-b-[3px] border-black hover:text-darkGray focus:text-darkGray hover:border-darkGray focus:border-darkGray transition duration-300"
                    >
