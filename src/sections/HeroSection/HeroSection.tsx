...
export default function HeroSection() {
  return (
    <section className="hero-section py-[60px] sm:py-[80px] md:py-[120px]">
      <Container className="flex relative flex-col z-[999] gap-[24px] sm:gap-[30px] md:gap-[42px]">
        ...
        <div className="flex gap-[15px] sm:gap-[20px] md:gap-[25px]">
          <a
            href="#"
            className="link group relative bg-[#0075FF] uppercase p-[1.1em] border-[1.5px] border-solid rounded-[3em] border-black inline-block"
          >
          ...
          <a
            href="#"
            className="link group relative uppercase p-[1.1em] border-[1.5px] border-solid rounded-[3em] border-white inline-block"
          >
            <span className="group-hover:opacity-0 group-focus:opacity-0 opacity-100">
              About me
            </span>
