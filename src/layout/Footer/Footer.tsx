                    ...
                    <ul>
                      <li>
                        <a
                          ...
                          className="dark-cursor hover:text-darkGray focus:text-darkGray hover:border-b-[1px] hover:border-darkGray hover:pb-[1px] focus:border-b-[1px] focus:border-white focus:pb-[1px] transition duration-300"
                        >
                          {item.emailto}
                        </a>
                      </li>
